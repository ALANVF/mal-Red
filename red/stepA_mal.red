			...
			"try*" [
				f: has [out e a3 err][
					...
					either none? err [
						...
						if (2 < length? ast) and any-seq? ast/3 [
							a3: ast/3
							if mal-symbol? a3/1 [
								if a3/1/name == "catch*" [
									e: make mal-env! []
									break/return mal.eval a3/3 (e/.init env reduce [a3/2] reduce [to-string err])
								]
							]
						]
